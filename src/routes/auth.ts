...
let userIds = 0
const users: {id: string, email: string, username: string, password: string}[] = []
...
router.post("/register", async (req: Request, res: Response) => {
    ...
    users.push({id: userIds.toString(), email, username, password: hashedPass})
    ...
    refreshTokens.push({userId: userIds.toString(), refreshToken})
